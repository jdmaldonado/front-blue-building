...
- **Comentarios: pocos, cortos y con motivo.** Dos líneas como máximo, y solo
  cuando el código no puede decirlo solo. Detalle y ejemplos:
  `escribir-comentarios/SKILL.md`.
